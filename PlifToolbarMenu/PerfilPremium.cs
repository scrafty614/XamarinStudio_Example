...
namespace PlifToolbarMenu
{
	...
	public class PerfilPremium : AppCompatActivity, ViewTreeObserver.IOnScrollChangedListener
	{
		...
		//botones y layouts de las tabs
		Button ubicacionbtn,descripcionbtn,contactobtn;
		LinearLayout ubicacionlayout,descripcionlayout,contactolayout;
		...
		Button deleteimgnegocio, imagennegocio, imagencamaranegocio, enviarimgneg, callnow;
