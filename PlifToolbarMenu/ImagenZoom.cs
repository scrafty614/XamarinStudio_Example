...
namespace PlifToolbarMenu
{
	...
	{
		private readonly ImagenZoom m_ScaleImageView;
		public ScaleImageViewGestureDetector(ImagenZoom imageView)
		{
	...
	public class ImagenZoom : ImageView, View.IOnTouchListener
	{
		...
		public ImagenZoom(Context context, IAttributeSet attrs) :
		base(context, attrs)
		{
			m_Context = context;
			Initialize();
		...
		public ImagenZoom(Context context, IAttributeSet attrs, int defStyle) :
